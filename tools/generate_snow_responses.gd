...
const RESPONSES := {
	&"snow_fog": {"rate": 0.000030, "cap": 0.12},
	&"blizzard": {"rate": 0.000080, "cap": 0.18},
	&"clear_break": {"rate": 0.000008, "cap": 0.08},
	&"freezing_rain": {"rate": 0.000006, "cap": 0.04},
	&"cold_snap": {"rate": 0.000006, "cap": 0.04},
}
...
func _initialize() -> void:
	...
	# Wind shift has no snowfall input, so its omitted response is meaningful:
	# wind transport belongs to the next phase and must not be smuggled in here.
